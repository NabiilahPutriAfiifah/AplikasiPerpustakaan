...
Public Class users
    ...
    Private regist As New ArrayList()
    ...
    Public Function checkAuth(username As String, ByVal plainPasword As String) As String
        'static password
        'Dim realPassword As String = EncrypData("1234")
        'Dim realUsername As String = "Nabila"
        ...
        For Each rowUser In getUser()
            ...
            If AuthUser = 0 Then
                Dim AuthPass = String.Compare(plainPasword, rowUser(1))
                If AuthPass = 0 Then
                    Return True
                End If
            End If
